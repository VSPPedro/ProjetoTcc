...
public class Test1_Ins_EM_AL{
	...
	public void test1(){
		try{
			...
			pro1.setNome("Fred");
			pro1.setEmail("soft@ifpb.edu.br");
			pro1.setSenha(PasswordUtil.encryptMD5("senhasoftcom"));
			pro1.setTelefone("8336031285");
			
			
			Professor pro2 = new Professor();
			pro2.setNome("Denio");
			pro2.setEmail("elfa@ifpb.edu.br");
			pro2.setSenha(PasswordUtil.encryptMD5("senhaelfa"));
